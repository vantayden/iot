...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>css/font-icons/entypo/css/entypo.css">
            ...
            <form method="post" role="form" id="form_login">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="identity" id="username" placeholder="Username" autocomplete="off" />
                    </div>
...
<script src="<?php echo base_url(); ?>js/neon-login.js"></script>
