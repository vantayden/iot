...
//                         icon = false,
//                         textLabel = false;
//                     $.each(['switch-mini', 'switch-small', 'switch-large'], function(i, el) { if (classes.indexOf(el) >= 0) myClasses = el });
...
//                     if (icon) { $label.html('<i class="icon ' + icon + '"></i>') }
...
//                     var changeStatus = function($this) { if ($element.parent('label').is('.label-change-switch')) {} else { $this.siblings('label').trigger('mousedown').trigger('mouseup').trigger('click') } };
...
//                         if ($this.closest('.has-switch').is('.deactivate')) { $this.unbind('click') } else if ($this.closest('.switch-on').parent().is('.radio-no-uncheck')) { $this.unbind('click') } else {
...
//             },
//             isActive: function() { return !$(this).hasClass('deactivate') },
...
//             },
//             toggleRadioStateAllowUncheck: function(uncheck, skipOnChange) { var $radioinput = $(this).find(':radio'); if (uncheck) { $radioinput.not(':checked').trigger('change', skipOnChange) } else { $radioinput.not(':checked').prop('checked', !$radioinput.is(':checked')).trigger('change', skipOnChange) } },
//             setState: function(value, skipOnChange) { $(this).find(inputSelector).prop('checked', value).trigger('change', skipOnChange) },
...
//                 var color = '';
//                 if (value !== undefined) {
//                     if ($(this).attr('data-on') !== undefined) { color = "switch-" + $(this).attr('data-on') }
...
//                 var color = '';
//                 if (value !== undefined) {
//                     if ($(this).attr('data-off') !== undefined) { color = "switch-" + $(this).attr('data-off') }
...
//                 if ($element.data('animated') !== false) { $element.addClass("switch-animate") } else { $element.removeClass("switch-animate") }
//             },
...
//                 })
//             },
//             status: function() { return $(this).find(inputSelector).is(':checked') },
//             destroy: function() {
//                 var $element = $(this),
